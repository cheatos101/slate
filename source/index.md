...
toc_footers:
  ...
  - <a href='https://bitbucket.org/carre/hexoskin-api-python-client'>REST API Python client</a>
...
Additionnally, there is a Python client available, see the left column. If you have implemented the API in another language and want to share it, be sure to write us an e-mail at [api@hexoskin.com](mailto:api@hexoskin.com) and we'll put it up along with the Python client.
...
Requests to lists return an object containing two members; meta contains information about the results and objects contains the actual results. A sample result from `/api/v1/datatype/?offset=20` is shown on the right:
...
Some Ranges will trigger additional processing, making more data available to you. Depending on the Range applied, HRV, sleep positions, and more become available. Refer to the Ranges documentation to see what Ranges makes which data available.
...
will always return you only the authenticated user's data. However, if you have friends or athletes, you can see their data with
...
Because it is returning a list, the previous call returns a maximum of 20 objects. If you want to see a different subset, check out [List views](#list-views) for more information.
...
Now that you know what data you want, and for which record or range, you can query as follow, using the IDs of the resources you want :
...
```json
{
    ...
    "objects": [
        ...
        },
        {
            ...
            "resource_uri": "/api/v1/trackpoint/27719/",
            "speed": 0,
            "time": "2014-08-29T09:25:06",
            "track": "/api/v1/track/80/",
            "vertical_accuracy": null
        },
        {"resource_uri":"..."}
...
* HRV average : 50 (Only available for specific ranges, will return -1 otherwise)
* Step count: 71
...
When you have your own list of favorite metrics, you can query
